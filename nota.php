    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="text-secondary font-weight-bold">
                No.Pembelian: <?php echo $detail_join['id_pembelian']; ?><br>
                Tanggal: <?php echo $detail_join['tanggal_pembelian']; ?><br>
                Total Belanja: <?php echo number_format($detail_join['total_pembelian'], 0, ",", "."); ?>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>Rp <?php echo number_format($detail_pmb_produk['harga_produk'], 0, ",", "."); ?></td>
    ...
    <div class="row">
        <div class="col-md-7">
            <div class="alert alert-danger">
                <p>
                    Silahkan melakukan pembayaran Rp <strong>
