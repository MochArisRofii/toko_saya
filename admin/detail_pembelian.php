...
$ambil_data_pelanggan = mysqli_query($config, "select * from pembelian join pelanggan
on pembelian.id_pelanggan=pelanggan.id_pelanggan
where pembelian.id_pembelian='$_GET[id]'");

$detail_data_pelanggan = mysqli_fetch_assoc($ambil_data_pelanggan);
?>
...
<table class="table table-bordered">
    <thead>
        ...
        <tbody>
            <?php
            $nomor = 1;
            $ambil_data_produk = mysqli_query($config, "select * from pembelian_produk
        ...
        where pembelian_produk.id_pembelian='$_GET[id]'");
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $detail_data_produk['harga_produk']
                            * $detail_data_produk['jumlah']; ?></td>
                </tr>
            <?php
                $nomor++;    
            }
