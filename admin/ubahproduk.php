...
<form method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="brt" value="<?php echo $data['berat_produk'] ?>">
    </div>
    <div class="form-group">
...
if(isset($_POST['ubahproduk'])) {
    ...
    if (!empty($lokasi)) {
        ...
        $sql = mysqli_query($config, "update produk set nama_produk='$namaproduk',harga_produk='$hargaproduk',
        berat_produk='$beratproduk',foto_produk='$fotoproduk', stok_produk='$stokproduk',
        deskripsi_produk='$deskripsiproduk',kategori='$kategori' WHERE id_produk='$_GET[id]'");
    } else {
        $sql = mysqli_query($config, "update produk set nama_produk='$namaproduk',harga_produk='$hargaproduk',
        berat_produk='$beratproduk', stok_produk='$stokproduk',
        deskripsi_produk='$deskripsiproduk',kategori='$kategori' WHERE id_produk='$_GET[id]'");
    }
