...
<form method="post">
    <div class="form-group form-inline">
        ...
        <a href="cetakongkir.php" class="btn btn-warning ml-2" target="_blank">Cetak</a>
        <a href="index.php?page=tambahongkir" class="btn btn-primary ml-auto">Tambah 0ngkir & Tarif</a>
    </div>
</form>
    ...
    <tbody>
        ...
        ?>  
                <tr>
                    ...
                    <td><a href="index.php?page=ubahongkir&id=<?php echo $data['id_ongkir']; ?>"
